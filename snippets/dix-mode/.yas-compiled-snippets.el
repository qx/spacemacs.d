                          ...
                          (and
                           ...
                           (not
                            (member
                             ...
                             '("l" "r" "i" "g" "sdefs")))))
                        nil nil "/Users/ok/.spacemacs.d/snippets/dix-mode/section" "direct-keybinding" nil)
                       ("<s" "<sdef n=\"$1\"  c=\"$2\"/>\n" "<sdef> element"
                        (progn
                          (backward-char 2)
                          (equal
                           (dix-enclosing-elt 'noerror)
                           "sdefs"))
                        nil nil "/Users/ok/.spacemacs.d/snippets/dix-mode/sdef" "direct-keybinding" nil)
                       ("<s" "<s n=\"$1\"/>$0" "<s> element"
                        (progn
                          (backward-char 2)
                          (member
                           (dix-enclosing-elt 'noerror)
                           '("l" "r" "i" "g")))
                        nil nil "/Users/ok/.spacemacs.d/snippets/dix-mode/s" "direct-keybinding" nil)
                        ...
                        (progn
                          ...
                          (not
                           (equal
                            (dix-enclosing-elt 'noerror)
                            "e")))
                        nil nil "/Users/ok/.spacemacs.d/snippets/dix-mode/pardef" "direct-keybinding" nil)
                       ("<p" "<par n=\"${1::$$(dix-yas-message-pardef (yas-choose-value (dix-pardef-suggest-for (dix-lemma-at-point))))`}\"/>$0" "<par> element"
                        (progn
                          ...
                          (equal
                           (dix-enclosing-elt 'noerror)
                           "e"))
                        nil nil "/Users/ok/.spacemacs.d/snippets/dix-mode/par" "direct-keybinding" nil)
                       ("<p" "<p><l>$1</l> <r>$1$0</r></p>" "<p> element"
                        (progn
                          ...
                          (equal
                           (dix-enclosing-elt 'noerror)
                           "e"))
                        nil nil "/Users/ok/.spacemacs.d/snippets/dix-mode/p" "direct-keybinding" nil)
                       ("<e" "<e> <p><l>$1</l>  <r>$1$0</r></p> </e>\n" "<e> in pardefs"
                        (not
                         (dix-enclosing-is-mono-section))
                        nil nil "/Users/ok/.spacemacs.d/snippets/dix-mode/e-in-pardef" "direct-keybinding" nil)
